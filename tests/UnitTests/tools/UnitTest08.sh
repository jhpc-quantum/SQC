...
CIRCUIT_OUT="../../../capi/build/UnitTest08.o"
COMMON="$CFLAGS_ALL -I $INCLUDE_PATH $SOURCE_FILE -L$LIBRARY_PATH -l$LIBRARY_NAME"

# Answer file
expected_error_file="../answer/UnitTest08.log"
...
gcc $COMMON  $MEMORY_FLAGS $CIRCUIT_FLAGS $MEMORY_SIZE $PROVIDER_FLAGS -o "$CIRCUIT_OUT"
if [ $? -ne 0 ]; then
