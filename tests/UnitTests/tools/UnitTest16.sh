...
CIRCUIT_OUT="../../../capi/build/UnitTest16.o"
COMMON="$CFLAGS_ALL -I $INCLUDE_PATH $SOURCE_FILE -L$LIBRARY_PATH -l$LIBRARY_NAME"

# Answer file
expected_error_file="../answer/UnitTest16.log"
# BASIC or FAKE or NONE
PROVIDER_FLAGS="-D FAKE"
# To transpile or not
TRANSPILE_FRAGS="-D ON_TRANSPILE"
# File is NULL
FILEVALUE_FRAGS="-D FILE_NULL"

gcc $COMMON  $PROVIDER_FLAGS $TRANSPILE_FRAGS $FILEVALUE_FRAGS -o "$CIRCUIT_OUT"
if [ $? -ne 0 ]; then
