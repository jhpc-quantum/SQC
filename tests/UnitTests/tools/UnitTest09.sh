...
CIRCUIT_OUT="../../../capi/build/UnitTest09.o"
COMMON="$CFLAGS_ALL -I $INCLUDE_PATH $SOURCE_FILE -L$LIBRARY_PATH -l$LIBRARY_NAME"

# Answer file
expected_error_file="../answer/UnitTest09.log"
...
# Set memory size to 50
MEMORY_SIZE="-D MEMORY_SIZE_50"

gcc $COMMON  $MEMORY_FLAGS $CIRCUIT_FLAGS $MEMORY_SIZE $PROVIDER_FLAGS $TRANSPILE_FRAGS -o "$CIRCUIT_OUT"
if [ $? -ne 0 ]; then
